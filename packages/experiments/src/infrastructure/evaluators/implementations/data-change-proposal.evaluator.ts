...
interface DataChangeProposalOutputs extends TextEvaluationOutputs {
  ...
  readonly dataChangeProposals?: Array<Record<string, unknown>>;
}
...
function toNormalizedProposal(
  ...
  logger.debug(`Normalizing actual proposal [${index}]`, {
    ...
    hasMutationVariables: !!(proposal.mutationQuery as Record<string, unknown>)?.variables,
    mutationVariablesType: typeof (proposal.mutationQuery as Record<string, unknown>)?.variables,
  });
