...
export function normalizeProposal(
  ...
  if (proposal.changeType === "creation") {
    return {
      changeType: "creation",
      relatedUserId: proposal.relatedUserId as string | undefined,
      mutationVariables: (proposal.mutationQuery as Record<string, unknown>)?.variables as Record<string, unknown> | undefined,
    };
  }

  return {
    changeType: "change",
    changedField: proposal.changedField as string | undefined,
    newValue: proposal.newValue as string | undefined,
    mutationQueryPropertyPath: (proposal.mutationQuery as Record<string, unknown>)?.propertyPath as string | undefined,
    relatedUserId: proposal.relatedUserId as string | undefined,
    mutationVariables: (proposal.mutationQuery as Record<string, unknown>)?.variables as Record<string, unknown> | undefined,
  };
}
