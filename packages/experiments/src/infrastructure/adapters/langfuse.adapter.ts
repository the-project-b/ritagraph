...
export class LangFuseAdapter implements ExperimentProviderAdapter {
  ...
  async deleteExperiment(id: string): Promise<boolean> {
    ...
    logger.warn("LangFuse may not support deleting experiments");
    return false;
  }
  ...
  async listPrompts(filter?: {
    ...
    logger.warn("LangFuse prompt listing not yet implemented");
    return [];
  }
  ...
  async pullPrompt(name: string): Promise<ProviderPrompt | null> {
    ...
    logger.warn("LangFuse prompt pulling not yet implemented");
    return null;
  }
