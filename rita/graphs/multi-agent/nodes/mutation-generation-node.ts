 ...
 */
export const mutationGenerationNode = async (state: ExtendedState, config: any) => {
...
Available Mutations:
${availableMutations.map((m: MutationInfo) => `
- ${m.name}
...
- Validate against the type information`;
    ...
    if (!generatedMutation.mutation?.name || !generatedMutation.mutation?.document) {
