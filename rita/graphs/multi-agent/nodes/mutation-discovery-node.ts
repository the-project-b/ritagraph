 ...
 */
export const mutationDiscoveryNode = async (state: ExtendedState, config: any) => {
  const startTime = Date.now();
  logEvent('info', AgentType.MUTATION, 'mutation_discovery_start', { startTime });
  ...
  try {
    ...
    logEvent('error', AgentType.MUTATION, 'mutation_discovery_error', { error: error.message });
