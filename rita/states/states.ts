  ...
  gatheredContext: Annotation<GatheredContext | undefined>({
    reducer: (existing, updated) => {
      ...
      return {
        ...
        dynamicContext: { ...existing.dynamicContext, ...updated.dynamicContext },
        userContext: { ...existing.userContext, ...updated.userContext },
        typeContext: {
          requiredParameters: [...new Set([...existing.typeContext.requiredParameters, ...updated.typeContext.requiredParameters])],
          optionalParameters: [...new Set([...existing.typeContext.optionalParameters, ...updated.typeContext.optionalParameters])],
          parameterTypes: { ...existing.typeContext.parameterTypes, ...updated.typeContext.parameterTypes }
        },
